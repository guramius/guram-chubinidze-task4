...
for (let i = 0; i < cities.length; i++) {
    ...
    for (let j = 0; j < cityDataKeys.length; j++) {
        const key = cityDataKeys[j];    
...
console.log(weatherData.Tbilisi.pollutionLevel);
console.log(weatherData.Batumi.pollutionLevel);
console.log(`Batumi High Temperature: ${weatherData.Batumi.temperature.high}`);  
